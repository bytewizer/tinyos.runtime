...
namespace Bytewizer.TinyOS.Sockets
{
    ...
    public interface IServerOptions
    {
        ...
        /// You can use <see cref="SocketListener.ActivePort" /> to give you the assigned port.
        /// </remarks>
        void Listen(int port, Action<SocketListenerOptions> configure);
        ...
        /// You can use <see cref="SocketListener.ActivePort" /> to give you the assigned port.
        /// </remarks>
        void Listen(IPAddress address, int port, Action<SocketListenerOptions> configure);
        ...
        /// <param name="configure">The <see cref="SocketListener"/> configuration options features.</param>
        void Listen(IPEndPoint endPoint, Action<SocketListenerOptions> configure);
